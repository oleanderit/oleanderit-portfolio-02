			...
			<div className="bg-white">
				<div className="container mx-auto px-4 md:px:14 lg:px-24 py-8 md:py-10 lg:py-12">
					...
					<div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-6">
						<div>
							<div className="group w-full bg-white relative flex flex-col items-center hover:bg-gray-800 shadow-md md:p-12 p-6">
								<div className="text-gray-600 group-hover:text-white flex flex-col items-center transition ease-linier ">
									<svg
										width={26}
										height={27}
										viewBox="0 0 26 27"
								...
								<div className="text-white group-hover:text-gray-800 transition ease-linier absolute bottom-0 -mb-6">
									<svg
										width={34}
										height={28}
										viewBox="0 0 34 28"
