			...
			>
				<div className="flex justify-center items-center lg:flex-row flex-col gap-8">
					...
					<div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
						<p className=" focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 font-normal text-base leading-4 text-gray-600 uppercase">
				...
				<div className="flex  justify-center items-center w-full pb-16">
					<div className="w-full sm:w-96 md:w-8/12 lg:w-full grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 lg:gap-16 sm:gap-x-6 sm:gap-y-12 gap-y-12 sm:mt-14 mt-10">
						<div>
							<svg
								width="50"
								height="50"
